...
import type { MulterFile } from '../users/interfaces/multer-file.interface';
...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Registra un nuevo usuario con email institucional ECI. Crea la cuenta en Supabase y el registro en Users y Profiles. El email de verificación es enviado por Supabase.',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @ApiResponse({
    status: 201,
    description:
      'Usuario y perfil creados exitosamente. Email de verificación enviado.',
  })
  @ApiResponse({
    status: 400,
    description: 'Email no pertenece al dominio ECI o datos inválidos.',
  })
  @ApiResponse({
    status: 409,
    description:
      'El email, teléfono, documento o ID de estudiante ya está registrado.',
  })
  register(
  ...
  @ApiOperation({
    ...
    description:
      'Página de redirección después de que el usuario verifica su email desde el enlace recibido.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Autentica al usuario con email y contraseña. Retorna access_token y refresh_token de Supabase.',
  })
